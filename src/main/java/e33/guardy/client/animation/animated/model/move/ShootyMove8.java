...
public class ShootyMove8<T extends ShootyEntity> extends ShootyModel<T> {
	...
	public ShootyMove8() {
		...
		setRotationAngle(right_cup, 0.0873F, 0.0F, 0.0F);
		...
		setRotationAngle(left_cup, 0.4363F, 0.0F, 0.0F);
		...
		setRotationAngle(left_shine, 0.7854F, 0.0F, 0.0F);
