...
public class ShootyMove2<T extends ShootyEntity> extends ShootyModel<T> {
	...
	public ShootyMove2() {
		...
		setRotationAngle(right_cup, 0.6109F, 0.0F, 0.0F);
		...
		setRotationAngle(right_shine, 0.4363F, 0.0F, 0.0F);
		...
		setRotationAngle(left_cup, 0.5236F, 0.0F, 0.0F);
		...
		setRotationAngle(left_shine, 0.1745F, 0.0F, 0.0F);
