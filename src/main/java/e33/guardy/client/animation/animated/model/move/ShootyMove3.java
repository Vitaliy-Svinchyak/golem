...
public class ShootyMove3<T extends ShootyEntity> extends ShootyModel<T> {
    ...
    public ShootyMove3() {
        ...
        setRotationAngle(right_shine, 0.9599F, 0.0F, 0.0F);
        ...
        setRotationAngle(right_step, -0.2618F, 0.0F, 0.0F);
