...
public class ShootyMove7<T extends ShootyEntity> extends ShootyModel<T> {
    ...
    public ShootyMove7() {
        ...
        setRotationAngle(right_leg, 0.0873F, 0.0F, 0.0F);
        ...
        setRotationAngle(left_shine, 0.9599F, 0.0F, 0.0F);
        ...
        setRotationAngle(arms, 0.0F, 0.1745F, 0.0F);
        chest.addChild(arms);
