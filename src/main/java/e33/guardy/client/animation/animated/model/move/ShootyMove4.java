package e33.guardy.client.animation.animated.model.move;//Made with Blockbench
...
public class ShootyMove4<T extends ShootyEntity> extends ShootyModel<T> {
	...
	public ShootyMove4() {
		...
		setRotationAngle(right_leg, -0.8727F, 0.0F, 0.0F);
		...
		setRotationAngle(right_cup, 0.4363F, 0.0F, 0.0F);
		...
		setRotationAngle(right_shine, 0.7854F, 0.0F, 0.0F);
		...
		setRotationAngle(left_cup, 0.0873F, 0.0F, 0.0F);
		...
		setRotationAngle(left_step, -0.2618F, 0.0F, 0.0F);
		...
		setRotationAngle(press, 0.1745F, 0.0F, 0.0F);
		body.addChild(press);
