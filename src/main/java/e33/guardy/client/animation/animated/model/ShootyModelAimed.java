package e33.guardy.client.animation.animated.model;

import e33.guardy.client.detail.modelBox.ModelBoxWithParameters;
...
public class ShootyModelAimed<T extends ShootyEntity> extends ShootyModel {
    ...
    public ShootyModelAimed() {
        ...
        shooty.setRotationPoint(0.0F, 17.75F, 0.0F);
        ...
        setRotationAngle(right_leg, -0.1745F, 0.5236F, 0.0F);
        ...
        setRotationAngle(right_cup, 0.1745F, 0.0F, 0.0F);
        ...
        setRotationAngle(right_shine, 0.0873F, 0.0F, 0.0F);
        ...
        setRotationAngle(right_step, -0.0873F, 0.0F, 0.0F);
        ...
        setRotationAngle(left_leg, -0.1745F, -0.7854F, 0.0F);
        ...
        setRotationAngle(left_cup, 0.2618F, 0.0F, 0.0F);
        ...
        setRotationAngle(left_step, -0.0873F, 0.0F, 0.0F);
        ...
        setRotationAngle(press, 0.0F, 0.2618F, 0.0F);
        body.addChild(press);
        ...
        setRotationAngle(head, 0.0F, -1.0472F, 0.0F);
        chest.addChild(head);
        ...
        setRotationAngle(right_arm, -0.1745F, 0.2618F, 0.5236F);
        ...
        setRotationAngle(right_cubit, 0.2618F, 0.2618F, -0.3491F);
        ...
        setRotationAngle(right_preshoulder, -0.3491F, -1.5708F, -0.9599F);
        ...
        setRotationAngle(weapon, 1.2217F, 0.0F, 0.0F);
        ...
        weapon.cubeList.add(new ModelBoxWithParameters(weapon, 6, 42, -0.8F, -3.1F, -11.5F, 2, 2, 1, 0.0F, false));
        ...
        weapon.cubeList.add(new ModelBoxWithParameters(weapon, 54, 48, -0.9F, -3.4F, 2.8F, 2, 2, 1, 0.0F, false));
        ...
        setRotationAngle(left_preshoulder, -1.2217F, 0.0F, 0.0F);
