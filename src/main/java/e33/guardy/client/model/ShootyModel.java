package e33.guardy.client.model;

import e33.guardy.client.animation.animator.Animator;
import e33.guardy.client.animation.animator.ShootyAnimator;
...
public class ShootyModel<T extends ShootyEntity> extends EntityModel<T> implements DynamicAnimationInterface {
    ...
    protected RendererModel weapon;
