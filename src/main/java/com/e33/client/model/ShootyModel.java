...
public class ShootyModel<T extends ShootyEntity> extends EntityModel<T> implements IHasArm, IHasHead {
    ...
    private final RendererModel knee;
    private final RendererModel hip;
    private final RendererModel cup;
    private final RendererModel left;
    private final RendererModel step2;
    private final RendererModel knee2;
    private final RendererModel hip2;
    private final RendererModel cup2;
    private final RendererModel body;
    private final RendererModel hips;
    private final RendererModel press;
    private final RendererModel chest;
    private final RendererModel arms;
    private final RendererModel right2;
    private final RendererModel shoulder;
    private final RendererModel preshoulder;
    private final RendererModel cup3;
    private final RendererModel left2;
    private final RendererModel shoulder2;
    private final RendererModel preshoulder2;
