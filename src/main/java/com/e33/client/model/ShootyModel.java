...
public class ShootyModel<T extends ShootyEntity> extends EntityModel<T> {
    ...
    public ShootyModel() {
        ...
        shoulder.cubeList.add(new ModelBoxWithParameters(shoulder, 24, 10, -6.2F, -19.4F, -6.5F, 3, 2, 4, 0.0F, false));
        shoulder.cubeList.add(new ModelBoxWithParameters(shoulder, 51, 1, -6.5F, -18.9F, -6.6F, 1, 1, 4, 0.0F, false));
        shoulder.cubeList.add(new ModelBoxWithParameters(shoulder, 8, 34, -5.5F, -19.7F, -6.6F, 2, 1, 4, 0.0F, false));
        shoulder.cubeList.add(new ModelBoxWithParameters(shoulder, 37, 21, -5.9F, -17.9F, -6.0F, 2, 3, 3, 0.0F, false));
        shoulder.cubeList.add(new ModelBoxWithParameters(shoulder, 44, 13, -5.91F, -15.9F, -5.5F, 2, 3, 2, 0.0F, false));
        shoulder.cubeList.add(new ModelBoxWithParameters(shoulder, 0, 47, -6.1F, -17.9F, -5.0F, 2, 5, 1, 0.0F, false));
        shoulder.cubeList.add(new ModelBoxWithParameters(shoulder, 34, 52, -6.2F, -16.9F, -6.1F, 1, 1, 3, 0.0F, false));
        ...
        preshoulder.cubeList.add(new ModelBoxWithParameters(preshoulder, 17, 2, -6.5F, -13.9F, -2.4F, 2, 2, 6, 0.0F, false));
        preshoulder.cubeList.add(new ModelBoxWithParameters(preshoulder, 9, 22, -6.8F, -13.4F, -1.4F, 2, 1, 5, 0.0F, false));

        cup3 = new RendererModel(this);
        cup3.setRotationPoint(0.0F, 0.0F, 0.0F);
        right2.addChild(cup3);
        cup3.cubeList.add(new ModelBoxWithParameters(cup3, 0, 2, -5.8F, -13.7F, -1.1F, 1, 1, 1, 0.0F, false));
        ...
        preshoulder2.cubeList.add(new ModelBoxWithParameters(preshoulder2, 14, 14, -4.3F, -14.5F, -3.1F, 2, 2, 6, 0.0F, false));
        preshoulder2.cubeList.add(new ModelBoxWithParameters(preshoulder2, 0, 20, -4.0F, -14.0F, -2.1F, 2, 1, 5, 0.0F, false));

        cup4 = new RendererModel(this);
        cup4.setRotationPoint(0.0F, 0.0F, 0.0F);
        left2.addChild(cup4);
        cup4.cubeList.add(new ModelBoxWithParameters(cup4, 0, 0, -5.4F, -13.7F, -1.1F, 1, 1, 1, 0.0F, false));
