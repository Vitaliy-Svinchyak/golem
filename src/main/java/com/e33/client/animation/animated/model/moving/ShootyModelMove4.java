...
public class ShootyModelMove4<T extends ShootyEntity> extends ShootyModel<T> {

	public ShootyModelMove4() {
		textureWidth = 64;
		textureHeight = 64;
		...
		setRotationAngle(right_shine, 1.0472F, 0.0F, 0.0F);
		...
		setRotationAngle(left_shine, 0.3491F, 0.0F, 0.0F);
