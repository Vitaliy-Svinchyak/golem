package com.e33.client.animation.animated.model.moving;//Made with Blockbench
...
public class ShootyModelMove2<T extends ShootyEntity> extends ShootyModelMove3<T> {

    public ShootyModelMove2() {
        textureWidth = 64;
        textureHeight = 64;
        ...
        setRotationAngle(right_cup, 0.3491F, 0.0F, 0.0F);
        ...
        setRotationAngle(right_shine, 0.3491F, 0.0F, 0.0F);
        ...
        setRotationAngle(left_leg, -0.8727F, 0.0F, 0.0F);
        ...
        setRotationAngle(left_cup, 0.3491F, 0.0F, 0.0F);
        ...
        setRotationAngle(left_shine, 1.0472F, 0.0F, 0.0F);
